...
public interface BookingService {
    ...
    List<BookingDto> getAllBookingsByBooker(String state, long bookerId, int from, int size);

    List<BookingDto> getAllBookingsByItemOwner(String state, long ownerId, int from, int size);
